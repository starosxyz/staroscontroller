...
(function () {
    ...
    var viewMap = {
        ...
        'app' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'settings' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'cluster' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'processor' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'partition' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'topo' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'topo2' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'device' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
        'flow' : 'https://wiki.onosproject.org/display/ONOS/The+ONOS+Web+GUI',
